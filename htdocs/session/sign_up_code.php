...
//   }
  ...
  $sql = "INSERT INTO customer_tb (fname,lname,mobileno,username,cpassword,email_id)
VALUES ('$fnamedata','$lnamedata', $phonenumberdata,'$usernamedata','$passworddata','$emaildata')";
