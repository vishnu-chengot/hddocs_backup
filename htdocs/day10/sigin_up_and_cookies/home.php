...
?>
 ...
 <!-- <h1>hai welcome
  ...
  <!-- <a href="destroy.php" class="btn btn-primary">Log out</a> -->
  ...
  <div class="carousel-inner">
    <div class="carousel-item height" >
      ...
      <div class="carousel-caption d-none d-md-block">
        <!-- <h5 class="text-success fs-1">Welcome </h5>
    ...
    <div class="carousel-item height active ">
      ...
      <div class="carousel-caption d-none d-md-block">
        <h5 class="text-dark fs-2 fw-bold">Welcome <?php echo $row['fname'] ?> <?php echo $row['lname'] ?></h5>
