              ...
              <div class="row mt-5">
                ...
                <div class="col-6">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nmae" name="new_name" value="<?php echo $row['seller_name']; ?>">
                    <span class="error">
                      <?php echo "$nameerror"; ?>
                    </span>
                  </div>
                  ...
                  <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="password" name="new_password" value="<?php echo $row['password']; ?>">
                    <span class="error">
                ...
                <div>
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="HTML"
                      name="new_check_list[]" <?php if(in_array("HTML",$check_array)) echo "checked "; ?>>
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="CSS"
                      name="new_check_list[]" <?php if(in_array("CSS",$check_array)) echo "checked "; ?>>
                  ...
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="Java scripts"
                      name="new_check_list[]" <?php if(in_array("Java scripts",$check_array)) echo "checked "; ?>>
                    <label class="form-check-label" for="inlineCheckbox3">Java scripts</label>

                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" value="Python" name="new_check_list[]"<?php if(in_array("Python",$check_array)) echo "checked "; ?>>
                    <label class="form-check-label" for="inlineCheckbox3">Python</label>
                  </div>
                  <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" value="pSQL" name="new_check_list[]" <?php if(in_array("pSQL",$check_array)) echo "checked "; ?>>
